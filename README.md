...
- 🎯 Entry points to execute your program using `python -m <wazuh_sca_rules_ru>` or `$ wazuh_sca_rules_ru` with basic CLI argument parsing.
...
Awesome wazuh_sca_rules_ru created by franchb
